      ...
      <div class="card">
        <div class="card-image">
          <figure class="image is-4by3">
            <img src={this.props.product.productUrl} alt="image"></img>
          </figure>
        </div>
        <div class="card-content">
          <p class="title product-title">{this.props.product.productName}</p>
          <a
            class="button is-primary"
            href={"product.html?id=" + this.props.product.productId.toString()}
            target="_blank"
          ></a>
        </div>
      </div>
